...
public struct CubeFractionCoordinates(double q, double r, double s)
{
	public readonly double Q = q;
	...
	public static CubeFractionCoordinates HexLerp(CubeFractionCoordinates a, CubeFractionCoordinates b, double t)
	{
		return new CubeFractionCoordinates(a.Q * (1 - t) + b.Q * t, a.R * (1 - t) + b.R * t, a.S * (1 - t) + b.S * t);
	}
        
	public static IList<CubeCoordinates> HexLinedraw(CubeCoordinates a, CubeCoordinates b)
	{
