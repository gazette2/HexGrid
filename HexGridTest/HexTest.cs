...
public class HexTest
{
	...
	{
		EqualHexArray("hex_linedraw", new List<CubeCoordinates> { new(0, 0, 0), new(0, -1, 1), new(0, -2, 2), new(1, -3, 2), new(1, -4, 3), new(1, -5, 4) }, CubeFractionCoordinates.HexLinedraw(new CubeCoordinates(0, 0, 0), new CubeCoordinates(1, -5, 4)));
	}
